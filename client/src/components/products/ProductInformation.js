...
import { Votebar, Button, RatingOption, Comment } from "..";
...
const ProductInformation = ({
  ...
  const handleSubmitRatingOption = async ({ comment, score }) => {
    if (!comment || !pid || !score) {
      alert("Please fill your rating");
      return;
    }
        ...
        showModal({
          ...
          modalChildren: (
            <RatingOption
              ...
              handleSubmitRatingOption={handleSubmitRatingOption}
            />
          ),
        })
      );
